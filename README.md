...
- **Denoising** of every stack (e.g. non-local means, as implemented in [ANTs](https://github.com/ANTsX/ANTs)
- **Bias field correction**, run slice-wise on each stack [N4 bias field correction](https://github.com/ANTsX/ANTs)).
